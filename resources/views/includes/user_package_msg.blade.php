<div class="instoretxt">
    ...
    <div class="credit">{{__('Package Duration')}} : <strong>{{ \Carbon\Carbon::parse(Auth::user()->package_start_date)->format('d M, Y') }}</strong> - <strong>{{ \Carbon\Carbon::parse(Auth::user()->package_end_date)->format('d M, Y') }}</strong></div>
