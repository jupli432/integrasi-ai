                    ...
                    <div class="navbar-collapse collapse" id="nav-main">
                        ...
                        <ul class="navbar-nav">
                            ...
                            @if (Auth::guard('company')->check())
                                <li class="nav-item">
                                    <a href="{{ url('/job-seekers') }}" class="nav-link">
                                        {{ __('Seekers') }}
                                    </a>
                                </li>
                            @else
                            ...
                            @if (Auth::check())
                                ...
                                @endif @if (Auth::guard('company')->check())
                                    <li class="nav-item postjob">
                                        <a href="{{ route('post.job') }}" class="nav-link register">
                                            {{ __('Post a job') }}
                                        </a>
                                    </li>
                                    <li class="nav-item dropdown userbtn">
                                    ...
                                    @endif
                                    <li class="nav-item dropdown langbtn">
                                        <a href="{{ url('/') }}" class="nav-link">
                                            <i class="fa-solid fa-language h3 m-0"></i>
                                        </a>
                                        <ul class="dropdown-menu">
