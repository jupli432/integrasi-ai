    ...
    <div class="authpages">
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="useraccountwrap">
                        <div class="userbtns">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li class="nav-item"><a class="nav-link {{ $c_or_e == 'candidate' ? 'active' : '' }}"
                                        data-bs-toggle="tab" href="#candidate" aria-expanded="true">{{ __('Candidate') }}</a>
                                </li>

                                <li class="nav-item"><a class="nav-link {{ $c_or_e == 'employer' ? 'active' : '' }}"
                                        data-bs-toggle="tab" href="#employer" aria-expanded="false">{{ __('Employer') }}</a>
                                </li>
                        ...
                        <div class="userccount whitebg">
                                        ...
                                        <div class="formrow{{ $errors->has('last_name') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="last_name"
                                                class="form-control 
                                                     ...
                                                     @enderror
                                               "
                                                required="required" placeholder="{{ __('Last Name') }}"
                                                value="{{ old('last_name') }}">
                                        ...
                                        <div class="formrow{{ $errors->has('email') ? ' has-error' : '' }}">
                                            ...
                                            <input type="email" name="email"
                                                class="form-control 
                                                     ...
                                                     @enderror
                                               "
                                                required="required" placeholder="{{ __('Email') }}"
                                                value="{{ old('email') }}">
                                    ...
                                    <form class="form-horizontal mt-3" method="POST"
                                        ...
                                        <div class="formrow{{ $errors->has('name') ? ' has-error' : '' }}">
                                            ...
                                            <input type="text" name="name"
                                                ...
                                                required="required" placeholder="{{ __('Name') }}"
                                                value="{{ old('name') }}">
                            ...
                            <div class="newuser"><i class="fas fa-user" aria-hidden="true"></i>
                                {{ __('Have Account') }}? <a href="{{ route('login') }}">{{ __('Sign in') }}</a></div>
                ...
                <div class="col-lg-7">
                    <div class="loginpageimg"><img src="{{ asset('/') }}images/login-page-banner.png" alt="">
                    </div>
                </div>
