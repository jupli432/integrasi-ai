...
@section('content')
    ...
    @include('includes.inner_page_title', [
        'page_title' => __('Kanban Board to manage applied jobseekers'),
    ])
                            ...
                            @if ($job_application->status == 'rejected')
                                ...
                                @if (null !== $job_application && null !== $user && null !== $job && null !== $company && null !== $profileCv)
                                    <div class="task" draggable="true" id="task{{ $job_application->id }}">
                                        ...
                                        <div class="jobinfo">
                                            <h3>{{ $user->getName() }}</h3>
                                            <div class="location d-flex mb-2"><i class="fas fa-map-marker-alt me-1"></i>
                                                {{ $user->getLocation() }}</div>
                                        </div>
                                        <div class="minsalary"><i class="fas fa-money-bill"></i>
                                            {{ $job_application->expected_salary }}
                                            {{ $job_application->salary_currency }}
                                            <span>/ {{ $job->getSalaryPeriod('salary_period') }}</span>
                                        </div>
                                    ...
                                    <div class="task" draggable="true" id="task{{ $job_application->id }}">
                                        ...
                                        <div class="d-flex justify-content-end jobskrbtnact">
                                            <a class="me-auto profbtn"
                                                href="{{ route('applicant.profile', $job_application->id) }}"
                                                target="_blank">{{ __('View Profile') }}</a>
                                            <button class="move-btn backward" onclick="moveTask(this, 'backward')">
                                                <i class="fas fa-reply"></i></button>
                                            <button class="move-btn forward ms-1" onclick="moveTask(this, 'forward')">
