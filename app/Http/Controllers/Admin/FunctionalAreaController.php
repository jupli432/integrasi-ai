...
class FunctionalAreaController extends Controller
{
    ...
    {
        $functionalAreas = FunctionalArea::select([
            'functional_areas.id',
            'functional_areas.functional_area',
            'functional_areas.is_active',
            'functional_areas.lang',
            'functional_areas.image',
            'functional_areas.is_default',
        ...
        return Datatables::of($functionalAreas)
            ...
            ->addColumn('image', function ($functionalAreas) {
                return '
                    <img width="48px" style="margin:auto" src="'.asset('uploads/functional_area/thumbnail/').'/'.$functionalAreas->image.'">
                ';
            })
            ...
            ->rawColumns(['image','functional_area', 'action'])
