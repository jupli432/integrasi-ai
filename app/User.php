...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    function lastOnlineDisplay(): string
    {
        if ($this->isOnline()) {
            return "Online";
        } else {
    ...
    public function latestProfileExperience()
    {
        return $this->hasOne('App\ProfileExperience', 'user_id', 'id')->latest('date_end');
    }
    ...
    public function latestProfileEducation()
    {
        return $this->hasOne('App\ProfileEducation', 'user_id', 'id')->latest('date_completion');
    }
...

    {
        ...
        return ImageUploadingHelper::print_image("user_images/$image", $width, $height, '/admin_assets/no-image.png', $this->getName());
    }
    ...
    {
        return $this->hasMany('App\CompanyMessage', 'seeker_id', 'id');
    }

    public function lastUserMessages(): ?CompanyMessage
    {
